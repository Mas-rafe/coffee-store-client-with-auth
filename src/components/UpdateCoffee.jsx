...
const UpdateCoffee = () => {
    const { _id, photo, Name, Quantity, Supplier, Price, Category, Details } = useLoaderData();
            ...
            <form onSubmit={handleUpdateCoffee}>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    ...
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
                        ...
                        <input type="text" className="input w-full" name='Quantity' defaultValue={Quantity} placeholder="Enter the Quantity of " />
                    </fieldset>
                    ...
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
                        ...
                        <input type="text" className="input w-full" name='Price' defaultValue={Price} placeholder="you can see the pice " />
                    </fieldset>
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
                        <label className="label">Category</label>
                        <input type="text" className="input w-full" name='Category' defaultValue={Category} placeholder="Enter Coffee Category" />
                    </fieldset>
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
